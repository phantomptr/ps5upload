...
backport_summary: "This will downgrade the game to the FW 4 SDK pair and install the {count}-library set that {profile} ships. A set is installed whole \u2014 mixing libraries across games is what makes a backport fail to launch.",
...
fakelibs_scan_body: "Read the libraries from games on this console that are already backported. {count} titles to check.",
fakelibs_scan_none: "No backported games found on this console, so there were no libraries to collect.",
fakelibs_scan_none_new: "Nothing new \u2014 you already have every set on this console.",
fakelibs_scan_progress: "Reading {done} of {total}\u2026 {current}",
fakelibs_scan_title: "Scan this console",
...
fakelibs_path_hint: "Folder holding manifest.json and profiles/, produced by scripts/gather-fakelibs.py from your own games. Each profile is one game's library set, installed whole \u2014 mixing libraries between games is what makes a backport fail to launch.",
fakelibs_path_ok: "{count} profiles available.",
...
backport_candidates: "{n} profiles available. If the game does not start, Undo and try the next one.",
backport_no_corpus: "No fakelib profiles are available. Set the fakelibs folder in Settings.",
backport_no_more: "Every available profile has been tried for this title.",
backport_library_size: "{name} ({size} bytes)",
backport_installed: "Backport files are installed",
backport_installed_body: "Installed the library set from {profile}. The payload overlay mounts it when the game launches. If the game does not reach gameplay, Undo and try the next profile.",
backport_partial: "Backport stopped partway",
backport_partial_body: "Undo now to restore the original SDK and libraries before trying another profile.",
